...
/*   Updated: 2022/10/14 19:11:14 by sdiaz-ru         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	*ft_countchar(char const *s, char c)
{
	...
	arrayt = (int *)malloc(frases * sizeof(int));
...
char	**ft_split(char const *s, char c)
{
	...
	arraystr = (char **)malloc((arrayt[0] + 1) * sizeof(char *));
	k = 0;
	while (k <= arrayt[0])
	{
		arraystr[k] = (char *)malloc((arrayt[k + 1] + 1) * sizeof(char));
		k++;
	}
	if (arraystr == NULL)
		return (NULL);
